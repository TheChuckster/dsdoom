...
#endif
int      FAT_fprintf(FAT_FILE *, const char *, ...);
/*-----------------------------------------------------------------
...
#define FAT_stdin ( (FAT_FILE *)1 )
#define FAT_stdout ( (FAT_FILE *)2 )
#define FAT_stderr ( (FAT_FILE *)2 ) 
#ifdef CAN_WRITE_TO_DISC
/*-----------------------------------------------------------------
...
int      FAT_fflush(FAT_FILE *); 

int      FAT_fscanf(FAT_FILE *, const char *, ...); 
